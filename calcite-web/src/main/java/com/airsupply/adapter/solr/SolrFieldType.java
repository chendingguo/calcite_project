...
/**
 * Type of a field in a solr entity.
 *
 * <p>
...
enum SolrFieldType {
	...
	private static final Map<String, SolrFieldType> MAP = new HashMap<String, SolrFieldType>();
	...
	SolrFieldType(Class<?> clazz, String simpleName) {
		this.clazz = clazz;
